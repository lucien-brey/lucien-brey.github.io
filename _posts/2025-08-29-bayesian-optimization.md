---
layout: distill
title: Bayesian Optimization (BO) from scratch
description: Tutorial on how to code your own BO from scratch
...
bibliography: bibliography/2025-08-29-bayesian-optimization.bib
...
Optimizing unkown functions -- also called black-box functions -- can prove to be a difficult task. Scientists often rely on domain-expertise, intuition and sequential changes to find optimal conditions. However, the hand-crafted methods prove to scale badly since human comprehension of multi-dimensional problems is limited or prove to be suboptimal with respect to the global optimum or regarding the amount of experiments needed to reach their goal. Keeping in mind sustainability, being experiment-efficient is crucial in order to minimize the amount of energy and materials needed.\
Probabilistic methods have gained tremendous interest in the few
